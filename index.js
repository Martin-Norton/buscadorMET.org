...
//         // Obtener los objetos en las páginas solicitadas
...
//         // Filtrar objetos nulos y eliminar aquellos sin imagen
//         const filteredObjects = objects.filter(obj => obj !== null && obj.imageUrl);

//         // Asegurarse de mostrar exactamente 20 objetos por página, si hay más de 20 disponibles
//         const objectsToShow = filteredObjects.slice((page - 1) * 20, page * 20);
//         const totalPages = Math.ceil(filteredObjects.length / 20);
